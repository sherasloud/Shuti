...
import { X, LogOut, CheckCircle2, ShieldCheck, Mail, User } from 'lucide-react';
        ...
        {user?.isLoggedIn ? (
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 pt-2">
              <button
                onClick={() => handleGoogleSignIn('shustobd@gmail.com', 'ShuSto BD Driver/Passenger', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=120')}
                disabled={loading}
                className="w-full p-3.5 rounded-xl border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50 text-slate-900 font-bold text-xs flex items-center justify-between transition-all shadow-sm hover:shadow active:scale-[0.99]"
              >
                <div className="flex items-center gap-3">
                  <img
                  ...
                  <div className="text-left">
                    <p className="text-xs font-bold text-slate-900">shustobd@gmail.com</p>
                    <p className="text-[10px] text-slate-400">Continue as ShuSto BD</p>
                  </div>
                </div>
